...
import pe.edu.upeu.sysalmacenfx.service.MarcaService;
import pe.edu.upeu.sysalmacenfx.service.ProductoService;
import pe.edu.upeu.sysalmacenfx.service.UnidadMedidaService;
...
// Agregar un listener al campo de texto txtFiltroDato para filtrar los productos
            txtFiltroDatos.textProperty().addListener((observable, oldValue, newValue) -> {
